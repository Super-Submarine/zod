  ...
  return (
    <header className="header">
      <Link to="/" className="header__logo">
        ...
        <span className="header__logo-suffix">.clone</span>
      </Link>

      <div className="header__deliver">
        <span className="header__deliver-to">Deliver to</span>
        <span className="header__deliver-location">
      ...
      <form className="header__search" onSubmit={handleSearch}>
        ...
        <button type="submit" className="header__search-button">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="#131921">
